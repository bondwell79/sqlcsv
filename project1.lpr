...
begin
  ...
  // parametros
  writeln('##################################################################');
  writeln(' SQLCSV version v0003 - Programado por Rubén Pastor Villarrubia');
  writeln;
  ...
  for tcolumna:=1 to query1.FieldCount-1 do registro:=registro+';"'+query1.Fields[tcolumna].FieldName+'"';
  writeln(fichero,registro);
    ...
    while not query1.eof do
          ...
          for tcolumna:=1 to query1.FieldCount-1 do registro:=registro+';"'+query1.Fields[tcolumna].Text+'"';
          writeln(fichero,registro);
          query1.next;
          end;
